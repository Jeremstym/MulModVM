...
poetry run python run.py data_base=/home/stympopper/data/DVMdata/features/ datatype=imaging_and_tabular fusion=True max_epochs=100 cross_fusion=True resnet_tokenization=True batch_size=256 num_workers=8 wandb_name=ResCross-512-3