...
poetry run python run.py data_base=/home/stympopper/data/DVMdata/features/ datatype=multimodal fusion=True max_epochs=100 batch_size=512 num_workers=16 tabular_embedding_dim=2048 tabular_model=mlp wandb_name=BobFusion-Transformer-MLP
