...
# poetry run python run.py data_base=/home/stympopper/data/DVMdata/features/ datatype=multimodal fusion=True max_epochs=100 batch_size=256 num_workers=8 use_transformer=True wandb_name=BobFusion1 persistent_workers=False
poetry run python run.py data_base=/home/stympopper/data/DVMdata/features/ datatype=imaging fusion=False evaluate=True max_epochs=150 batch_size=512 num_workers=8 wandb_name=BobBaseline-Image-Fast-Unaugmented