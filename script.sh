...
poetry run python run.py data_base=/home/stympopper/data/DVMdata/features/ datatype=multimodal max_epochs=100 pretrain=True batch_size=128 num_workers=22 use_cache=False use_transformer=False wandb_name=BoB-Baseline1-TrueDS
