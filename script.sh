...
poetry run python run.py data_base=/home/stympopper/data/DVMdata/features/ datatype=multimodal max_epochs=100 pretrain=True batch_size=256 num_workers=16 persistent_workers=True use_cache=False use_transformer=True one_hot=False wandb_name=Bob-Transformer
