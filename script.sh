...
poetry run python run.py data_base=/home/stympopper/data/DVMdata/features/ datatype=multimodal fusion=True cross_fusion=True image_tokenization=True max_epochs=100 batch_size=256 num_workers=16 wandb_name=FusionCrossAtt-SelfAtt