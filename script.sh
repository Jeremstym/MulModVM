...
poetry run python run.py data_base=/home/stympopper/data/DVMdata/features/ datatype=imaging_and_tabular fusion=True cross_fusion=True image_tokenization=True max_epochs=100 batch_size=256 num_workers=8 wandb_name=CrossAttImg768