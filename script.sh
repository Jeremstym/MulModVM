...
poetry run python run.py data_base=/home/stympopper/data/DVMdata/features/ datatype=multimodal fusion=True max_epochs=100 batch_size=512 num_workers=16 tabular_model=transformer use_xtab=True tabular_embedding_dim=192 wandb_name=BoBFusion-Transformer-XTab_v2