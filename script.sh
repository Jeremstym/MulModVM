...
poetry run python run.py data_base=/home/stympopper/data/DVMdata/features/ datatype=multimodal max_epochs=100 pretrain=True batch_size=256 num_workers=4 persistent_workers=True use_cache=False use_transformer=False one_hot=True wandb_name=BoB-Baseline
