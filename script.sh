...
poetry run python run.py data_base=/home/stympopper/data/DVMdata/features/ datatype=multimodal max_epochs=500 pretrain=True batch_size=512 num_workers=4 use_cache=False use_transformer=False one_hot=True wandb_name=BoB-Baseline
